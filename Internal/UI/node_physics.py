...
class ContinuumFlowPhysicsNode0(node_base.ContinuumFlowBaseNode):
    ...
    temperature_dissipation: FloatProperty(name="Temperature Dissipation", default=2, min=0.0, soft_min=0.0, soft_max=100.0, precision=2, subtype="PERCENTAGE", description="how quickly temperature dissipates")  # type: ignore
    temperature_production_rate: FloatProperty(name="Temperature Production Rate", default=20, min=0.0, soft_min=0.0, soft_max=100.0, precision=2, subtype="PERCENTAGE", description="how much temperature is produced due to burning")  # type: ignore
    ...
    expansion_rate: FloatProperty(name="Expansion Rate", default=30, min=0.0, soft_min=0.0, soft_max=100.0, precision=2, subtype="PERCENTAGE", description="how strongly hot air expands")  # type: ignore
    ...
    smoke_production_rate: FloatProperty(name="Smoke Production Rate", default=20, min=0.0, soft_min=0.0, soft_max=100.0, precision=2, subtype="PERCENTAGE", description="how much smoke is produced due to burning")  # type: ignore
    ...
    fuel_burn_rate: FloatProperty(name="Fuel Burn Rate", default=10, min=0.0, soft_min=0.0, soft_max=100.0, precision=2, subtype="PERCENTAGE", description="How quickly fuel burns away")  # type: ignore
