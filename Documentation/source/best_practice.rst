...
- The most important rule: when something looks weird try reducing the CFL number. This sadly comes at the cost of longer compute times, but it can often fix issues.
