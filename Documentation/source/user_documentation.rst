...
**Iterations**
    Number of solver iterations. Usually the default of two is fine. Less itterations means a faster solve, but this can come at the cost of visual consistency.
...
**Scale**
    Scale of the randomness of the combustion process.

**Amplitude**
    How random the combustion process is. Higher values mean more randomness.
...
**Fields**
    Lets you select which of the available fields you want to save.
...
**Fuel Concentration**
    Fuel concentration spawned within the source. 

**Smoke Concentration**
    Smoke concentration spawned within the source. 
...
**Source Noise**
    Activates random variations of the source fields to create more dynamic and interesting flow. Does not affect velocity.
