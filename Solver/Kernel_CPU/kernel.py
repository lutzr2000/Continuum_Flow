...
def _initialise_solver(config):
    ...
    u, v, w, p, T, smoke, fuel, flame = apply_all_BC(
        ...
        cpu_constants["HAS_OBSTACLE_VELOCITY"],
        ...
        cpu_fields["source_entry_masks"],
        cpu_fields["source_temperature_values"],
        cpu_fields["source_smoke_values"],
        cpu_fields["source_fuel_values"],
        cpu_fields["source_velocity_enabled"],
        cpu_fields["source_velocity_x_values"],
        cpu_fields["source_velocity_y_values"],
        cpu_fields["source_velocity_z_values"],
    )
    cpu_fields["u"] = u
    cpu_fields["v"] = v
    cpu_fields["w"] = w
...
def _run_time_step(state):
    ...
    p = pressure_solve.pressure_poisson(
        ...
        cpu_fields["source_mask"],
        cpu_fields["source_entry_masks"],
        cpu_fields["source_extra_pressure_values"],
        cpu_constants["DELTA"],
        cpu_constants["RHO"],
