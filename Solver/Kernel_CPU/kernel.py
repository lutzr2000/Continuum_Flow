...
def get_source_values(
    ...
    property_map = {
        "temperature": ("temperature", None, CPU_FIELD_DTYPE, 1.0),
        "smoke": ("smoke", None, CPU_FIELD_DTYPE, 1.0),
        "fuel": ("fuel", None, CPU_FIELD_DTYPE, 1.0),
        "noise_scale": ("noise_scale", None, CPU_FIELD_DTYPE, 1.0),
        "noise_amplitude": ("noise_amplitude", None, CPU_FIELD_DTYPE, 0.01),
        "noise_seed": ("noise_seed", None, np.int32, 1.0),
        "noise_enabled": ("source_noise", None, np.bool_, 1.0),
        "velocity_x": ("velocity", 0, CPU_FIELD_DTYPE, 1.0),
        "velocity_y": ("velocity", 1, CPU_FIELD_DTYPE, 1.0),
        "velocity_z": ("velocity", 2, CPU_FIELD_DTYPE, 1.0),
        "extra_pressure": ("extra_pressure", None, CPU_FIELD_DTYPE, 1.0),
    }
    values = {
...
def solver(
    ...
    *,
    ...
    while t < t_max:
        ...
        with timings.section("solver", "get_simulation_values"):
